...
<!--             <form class="appointment__form"  action="fileUpload" id="frm" method="post" enctype="multipart/form-data"> -->
               <div class="text-center">
                  ...
                  <p style="color:#5768AD;">▶ 간단 소개는  <span style="color:#FC7F65;">64자 이하</span>로 작성해주시기 바랍니다.</p>
                  ...
                  <form id="frm" class="appointment__form" method="post" 
                           ...
                           <div class="col-lg-6 text-center mypage_myinfo"
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-12 text-center">
                                    <textarea  
                                       id="trainerAward" name="simpleIntro" style="background-color: #3f51b50d; color: black; margin-bottom: 20px;resize: none;" placeholder="간단 소개를 입력하세요"></textarea>
                           ...
                           <div class="col-lg-6 text-center mypage_myinfo"
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-12 text-center">
                                    <textarea  
                                       id="trainerAward" name="profileMemo" style="background-color: #3f51b50d; color: black; margin-bottom: 20px;resize: none;height: 200px;" placeholder="프로필 메모를 입력하세요"></textarea>
