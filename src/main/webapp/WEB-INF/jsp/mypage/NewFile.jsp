...
//    var file_val=$(".filebox input[type='file']").val();   
...
//    formData.append("lessonTitleComment", $("#lessonTitle").val());
//    formData.append("lessonBalance", $("#lessonTitle").val());
//    formData.append("lessonFlex", $("#lessonTitle").val());
//    formData.append("lessonStrong", $("#lessonTitle").val());
//    formData.append("lessonCore", $("#lessonTitle").val());
//    formData.append("lessonIntro", $("#lessonTitle").val());
//    formData.append("lessonPrice", $("#lessonTitle").val());
//    formData.append("lessonMonth", $("#lessonTitle").val());
//    formData.append("fileRealName", $("#file").val());
//    formData.append("fileRealName", filePathSplit[2]);
//    formData.append("fileSaveName", guid() + "_" + fileRealName);
//    formData.append("filePath", fileSaveName);
